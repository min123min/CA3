...
print(json.dumps(sec.getsections[3]['summary'], indent=4, sort_keys=True))
...
month = parser.parse(list(sec.getsections)[3]['name'].split('-')[0])
...
data = [{'type': 'num', 'section': 3, 'summary': '', 'summaryformat': 1, 'visible': 1 , 'highlight': 0, 'sectionformatoptions': [{'name': 'level', 'value': '1'}]}]
